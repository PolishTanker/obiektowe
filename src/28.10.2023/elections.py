...
class VoterEligibilityValidator:
    ...
    def is_valid(self, name: str) -> bool:
        # Sprawdzenie, czy nazwa ma co najmniej 3 znaki
        if len(name) < 3:
            return False
        
        # Sprawdzenie, czy zawiera co najmniej jedną dużą literę, jedną małą literę i jedną cyfrę
        has_upper = False
        has_lower = False
        has_digit = False
        for char in name:
        ...
        # Wymagane są wszystkie trzy elementy: duża litera, mała litera i cyfra
